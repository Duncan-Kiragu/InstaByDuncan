...
# Importing django_rest_framework files
...
# Updating profile for users - must be logged in
@login_required(login_url='login')
...
# Model for commenting - User login required
@login_required(login_url='login')
...
# Model classes for likes - liking and disliking
...
def search_profile(request):
    if 'search_user' in request.GET and request.GET['search_user']:
        ...
        return render(request, 'instagram/search_results.html', params)
    else:
